    ...
    <div className="border-b border-gray-200 bg-white sticky top-0 z-40">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
        ...
        <div className="flex flex-col gap-1 flex-1">
          <h1 className="text-gray-800 text-lg sm:text-xl lg:text-2xl">{jobTitle}</h1>
          <p className="text-gray-500 text-sm sm:text-base">{packageSize}</p>
        </div>
        
        {/* Rechter Bereich */}
        <Button 
          onClick={onDownloadZip}
          className="bg-[#2d2d2d] hover:bg-[#1a1a1a] text-white w-full sm:w-auto"
        >
