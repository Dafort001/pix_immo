      ...
      <div className="absolute left-2 sm:left-8 top-4 sm:top-1/2 sm:-translate-y-1/2 bg-white/95 backdrop-blur-sm rounded-lg shadow-xl p-2 sm:p-4 flex flex-row sm:flex-col gap-2 sm:gap-3">
        ...
        <button
          ...
          className={`p-2 sm:p-3 rounded transition-colors ${
            currentTool === 'pen' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
          }`}
          title="Stift"
        >
        ...
        <button
          ...
          className={`p-2 sm:p-3 rounded transition-colors ${
            currentTool === 'arrow' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
          }`}
          title="Pfeil"
        >
        ...
        <button
          ...
          className="p-2 sm:p-3 rounded bg-gray-100 text-gray-700 hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          title="Rückgängig"
        >
        ...
        <button
          ...
          className={`p-2 sm:p-3 rounded transition-colors ${
            currentTool === 'eraser' ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
          }`}
          title="Radierer"
        >
        ...
        <button
          onClick={handleSave}
          className="p-2 sm:p-3 rounded bg-green-500 text-white hover:bg-green-600 transition-colors"
          title="Speichern"
        >
        ...
        <button
          onClick={onClose}
          className="p-2 sm:p-3 rounded bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors"
          title="Abbrechen"
        >
