...
export default function LoginOTPVerify() {
  ...
  const recipientEmail = "mail@beispiel.de"; // This would come from previous page state
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    if (code.length === 6) {
      ...
      if (code === "123456") {
        setMessage({
          type: "success",
          text: "Anmeldung erfolgreich – willkommen bei PIX.IMMO!",
        });
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <SEOHead
        title="Code eingeben"
        description="Geben Sie den 6-stelligen Login-Code ein."
      ...
      >
        ...
        <div className="text-center" style={{ marginBottom: "16px" }}>
          <h1 className="text-2xl mb-2">Code eingeben</h1>
        ...
        <form onSubmit={handleVerify}>
          ...
          <div className="text-center">
            <p className="text-xs leading-relaxed" style={{ color: "#777", fontSize: "11px", lineHeight: "1.6" }}>
              ...
              Wenn Sie keinen Code erhalten haben, prüfen Sie bitte Ihren Spam-Ordner<br />
