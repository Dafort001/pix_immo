  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        {/* Items info */}
        <div className="text-xs sm:text-sm text-gray-600 order-2 sm:order-1" data-testid="text-items-info">
        ...
        <div className="flex items-center gap-2 order-1 sm:order-2">
          ...
          <div className="sm:hidden px-3 py-1.5 text-sm text-gray-700 bg-gray-100 rounded" data-testid="text-mobile-page-indicator">
