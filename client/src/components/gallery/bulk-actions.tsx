...
export function BulkActions({ 
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-30 animate-in slide-in-from-bottom-4" data-testid="bulk-actions-bar">
      <div className="bg-[#2d2d2d] text-white rounded-full shadow-2xl px-4 sm:px-6 py-3 sm:py-4 flex items-center gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2">
          {packageCount !== undefined ? (
            <>
              {/* Package Images */}
              <div className="flex items-center gap-2 px-3 py-1 bg-green-500/20 border border-green-500/30 rounded-full" data-testid="text-package-count">
              ...
              {hasAdditionalImages && (
                <>
                  ...
                  <div className="flex items-center gap-2 px-3 py-1 bg-amber-500/20 border border-amber-500/30 rounded-full" data-testid="text-additional-count">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="bg-blue-500 text-white text-xs sm:text-sm h-8 sm:h-9"
