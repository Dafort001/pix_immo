...
export function PackageSelector({ 
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6" data-testid="package-selector">
      <div className="space-y-4">
        {/* Header */}
        <div>
          <h3 className="text-gray-900" data-testid="text-package-title">Ihr Paket</h3>
        ...
        {additionalImagesCount > 0 && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 space-y-2" data-testid="additional-images-info">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-700">
                Zusätzliche Bilder:
              </span>
              <span className="text-sm text-gray-900" data-testid="text-additional-images-cost">
        ...
        {additionalImagesCount === 0 && (
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg" data-testid="package-summary">
            <span className="text-sm text-gray-600">
              {selectedPackage.imageCount} Bilder im Paket enthalten
            </span>
            <span className="text-gray-900" data-testid="text-package-price">
