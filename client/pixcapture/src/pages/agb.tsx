      ...
      <div className="min-h-full bg-[var(--color-white)] flex flex-col" style={{ paddingTop: '59px', paddingBottom: '34px' }}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-8" style={{ paddingBottom: '40px' }}>
          <h1 className="text-[var(--color-black)] mb-8">
            Allgemeine Geschäftsbedingungen für die Nutzung der pixcapture.app
          </h1>
          ...
          <div className="space-y-8 pb-8">
            <div>
              ...
              <p className="text-[var(--color-grey)] mb-2">
                (1) Diese Allgemeinen Geschäftsbedingungen regeln die Nutzung der mobilen Applikation „pixcapture.app" (nachfolgend „App") durch registrierte oder sich registrierende Kunden der Plattform pix.immo.
              </p>
              <p className="text-[var(--color-grey)] mb-2">
            ...
            <div>
              ...
              <p className="text-[var(--color-grey)] mb-2">
                (1) Die Verarbeitung personenbezogener Daten erfolgt im Einklang mit der Datenschutzerklärung von pix.immo, die unter <a href="/datenschutz" className="text-[var(--color-blue)] hover:underline">pix.immo/datenschutz</a> abrufbar ist.
              </p>
              <p className="text-[var(--color-grey)] mb-2">
            ...
            <div>
              <h3 className="text-[var(--color-black)] mb-3">§ 7 Schlussbestimmungen</h3>
              <p className="text-[var(--color-grey)] mb-2">
